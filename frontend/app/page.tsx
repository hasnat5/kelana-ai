  ...
  return (
    <div className="relative flex min-h-full flex-1 flex-col overflow-x-hidden bg-background">
      ...
      <main className="relative z-10 mx-auto flex w-full max-w-lg flex-1 flex-col px-4 py-8 sm:px-6 sm:py-12">
        {/* Top nav: trip history */}
        <div className="mb-6 flex justify-end">
          <Link
            href="/trips"
            className="sketch-border inline-flex items-center gap-2 bg-paper px-4 py-2 font-hand text-lg font-semibold text-ink transition-transform duration-150 hover:-translate-y-0.5 hover:rotate-0 rotate-1"
          >
            <PlaneDoodle className="h-4 w-4 text-sky" />
            Trip History
          </Link>
        </div>
